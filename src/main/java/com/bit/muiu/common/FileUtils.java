...
public class FileUtils {
    ...
    public MindColumnFileDto parserFileInfo(MultipartFile multipartFile, String directory) {
        String bucketName = "bitcamp126";

        MindColumnFileDto mindColumnFileDto = new MindColumnFileDto();
...
//                mindColumnFileDto.setFiletype("image");
//            } else {
//                mindColumnFileDto.setFiletype("etc");
//            }
//        } else {
//            mindColumnFileDto.setFiletype("etc");
//        }

        mindColumnFileDto.setMcf_name(fileName);
        mindColumnFileDto.setMcf_originname(multipartFile.getOriginalFilename());
        mindColumnFileDto.setMcf_path(directory);

        return mindColumnFileDto;
    }
